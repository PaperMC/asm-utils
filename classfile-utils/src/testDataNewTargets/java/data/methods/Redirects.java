...
public final class Redirects {
    ...
    public static void addEntityAndPlayer(final Player root, final Player player, final Entity entity) {
        root.addEntityAndPlayer(player, entity);
    }
    ...
    public static void addEntityAndPlayerStatic(final Player player, final Entity entity) {
        Player.addEntityAndPlayerStatic(player, entity);
    }
